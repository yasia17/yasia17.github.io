...
function myFunction() {
  ...
  document.getElementById("p1").innerHTML = "hello " + person + ", welcome to our website! we are all about traveling around the world so even when covid 19 is here you will still be able to find cool places to visit press start to choose where to go";
  document.getElementsByName("startBtn")[0].style.visibility = "visible";
